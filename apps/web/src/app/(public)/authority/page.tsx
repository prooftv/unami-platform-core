        ...
        {authorities.length > 0 ? (
          <div className="space-y-3">
            {authorities.map((authority, i) => (
              <div key={authority._id} className="flex gap-4 rounded-xl border bg-card p-5">
                ...
                <div>
                  <p className="font-medium text-sm">{authority.title}</p>
                  {authority.description && (
                    <p className="text-xs text-muted-foreground mt-0.5">{authority.description}</p>
                  )}
                </div>
              </div>
            ))}
          ...
          <div className="rounded-xl border border-dashed py-16 text-center">
            <p className="text-sm text-muted-foreground">Authority profiles coming soon.</p>
          </div>
        )}
      </div>
